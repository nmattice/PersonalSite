...
const ToDo = () => {
  ...
  return (
    <>
      <header className="flex justify-center p-4 text-white text-xl font-semibold">
        Task Tracker
      </header>
      <main className="flex flex-col min-h-screen">
        ...
        <div className="grid grid-cols-2 gap-4 p-4">
          <div className="flex flex-col space-y-2">
            <h2 className="font-semibold text-white text-lg">Incomplete ({incompleteTasks.length})</h2>
          ...
          <div className="flex flex-col space-y-2">
            <h2 className="font-semibold text-white text-lg">Complete ({completedTasks.length})</h2>
